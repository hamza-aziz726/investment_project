        ...
        ***********************************-->
		<div class="nav-header">
            <a href="#" class="brand-logo">
				...
				{{-- <img src="{{ asset($setting->logo ?? '') }}" width="50" height="50" alt="Current Logo" class="img-fluid" /> --}}
				<div class="brand-title">
					{{-- <h2 class="">{{ $setting->site_name ?? '' }}</h2> --}}
                    <h3 class="mb-0" style="font-weight: 600; color: #4E3F6B;">Next Millioner</h3>
					<span class="brand-sub-title">@nextmillioner</span>
				</div>
            </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown  header-profile">
								<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
									<img src="{{ asset("backend-assets/images/user.jpg") }}" width="56" alt="">
								</a>
								<div class="dropdown-menu dropdown-menu-end">
